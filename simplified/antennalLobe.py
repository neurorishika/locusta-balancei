...
G_sgaba = [0.0]*p_n+[0.0]*l_n #0.09      # sGABA Conductance
...
PN_scale = 0.0#1.00#30/current_input[:p_n,:].max()/60 # PN Scaling Factor
...
current_input[p_n:,:] = (current_input[p_n:,:] * LN_scale)# ((current_input[p_n:,:]-LNbase)/(LNpeak-LNbase)*(1.0*LNbase)+LNbase) * LN_scale
