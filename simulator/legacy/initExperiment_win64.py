...
call(['python', homepath+'locusta-balancei/simulator/receptorLayer.py', odor_path, protocol_path, locust_path, folder])
...
copy(homepath+"locusta-balancei/simulator/antennalLobe.py",folder)
