...
g_fgaba = [float(sys.argv[6])]*p_n+[0.4]*l_n        # fGABA Conductance
...
PN_scale = 32/current_input[:p_n,:].max()/60 # PN Scaling Factor
LN_scale = 3/current_input[p_n:,:].max()/40 # LN Scaling Factor
